...
public class Marker {
	...
	public static void main(String[] args) {
		...
		// you should NOT be able to make an Item - following line shouldn't compile if
		// uncommented
		// new Item(0, 0, 0);
...
//		a.tick();
	...
	System.out.println(new Weed()); // should print "#"
		...
		// uncomment this section once you get to it
		 ...
		 Field testField = new Field(5, 5); System.out.println(testField.get(3, 3));
//		 //should print "." System.out.println(testField); //should print the field
		 System.out.println(testField.getValue()); //should print 0 a = new Apples();
		 a.setAge(5); testField.plant(0, 0, a);
